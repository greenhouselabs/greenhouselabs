...
export function NewsletterForm({
  ...
  className = "",
  formClassName = "mx-auto flex max-w-md min-w-0 flex-col gap-2 sm:flex-row",
  inputClassName = "min-w-0 w-full flex-1 rounded-xl border border-white/10 bg-neutral-900/60 px-4 py-2.5 text-sm placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 disabled:opacity-50",
  placeholder = "you@studio.com",
  source = "website",
  successMessage,
  tags = ["greenhouse-updates"],
}: NewsletterFormProps) {
