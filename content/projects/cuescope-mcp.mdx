...
links:
  ...
  release: "https://github.com/greenhouselabs/cuescope-mcp/releases/tag/v1.0.2"
  demo: "/products/cuescope-mcp"
offer:
  type: "product"
  status: "Public npm launch live. v1.0.2."
...
[View the product page](/products/cuescope-mcp), [open the npm package](https://www.npmjs.com/package/@greenhouselabs/cuescope-mcp), [review the public repository](https://github.com/greenhouselabs/cuescope-mcp), or [read the v1.0.2 release](https://github.com/greenhouselabs/cuescope-mcp/releases/tag/v1.0.2).
